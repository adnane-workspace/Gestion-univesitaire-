...
<body class="h-full flex items-center justify-center p-6 relative overflow-hidden">
    ...
    <div class="w-full max-w-md relative">
        <div class="text-center mb-10">
            <div class="inline-flex items-center justify-center mb-6 group hover:scale-110 transition-transform duration-500">
                <img src="{{ asset('logo.png') }}" alt="Logo" class="w-40 h-40 object-contain">
            </div>
            <p class="text-slate-500 mt-3 font-medium">@yield('subtitle')</p>
        </div>

        <div class="bg-white p-10 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-slate-100 relative overflow-hidden">
            <!-- Decorative line -->
