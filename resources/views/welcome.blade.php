...
<body class="bg-[#F8FAFC] text-slate-900 overflow-x-hidden">
        ...
        <div class="max-w-7xl mx-auto flex items-center justify-between px-8 py-4 glass rounded-[2rem] shadow-sm">
            ...
            <div class="flex items-center gap-4">
                @auth
                    ...
                    @endphp
                    <a href="{{ $dashboardUrl }}"
                        class="px-6 py-2.5 rounded-xl bg-[#4F46E5] text-white font-bold text-sm shadow-xl shadow-indigo-200 hover:bg-[#4338CA] transition-all">
                        Tableau de bord
                    </a>
                @else
                    <a href="{{ route('login') }}"
    ...
    <header class="relative min-h-screen flex items-center pt-24 px-6 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto w-full relative z-10 text-left">
            <div
                class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-indigo-300 text-xs font-black uppercase tracking-widest mb-8">
                <span class="relative flex h-2 w-2">
                    <span
                        class="animate-ping absolute inline-flex h-full w-full rounded-full bg-indigo-400 opacity-75"></span>
                    <span class="relative inline-flex rounded-full h-2 w-2 bg-indigo-500"></span>
                </span>
                Bienvenue à l'Université Panafricaine
            </div>
            <h1 class="text-6xl md:text-8xl font-black text-white leading-[1.1] tracking-tighter mb-8">
                L'avenir de la gestion <br />
                <span class="text-[#4F46E5] uppercase tracking-widest text-4xl md:text-6xl block mt-4">Académique</span>
            </h1>
            <p class="max-w-2xl text-xl text-slate-300 font-medium leading-relaxed mb-12">
                Simplifiez la vie de vos étudiants, professeurs et administrateurs avec une plateforme intuitive,
                robuste et sécurisée conçue pour l'excellence.
            </p>
    ...
    <section id="features" class="py-32 px-6">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                <!-- Admin Card -->
                <div
                    class="bg-white p-12 rounded-[3rem] border border-slate-100 shadow-[0_20px_50px_rgba(0,0,0,0.02)] hover:shadow-xl hover:-translate-y-2 transition-all group">
                    <div
                        class="w-16 h-16 rounded-2xl bg-indigo-50 text-indigo-600 flex items-center justify-center mb-8 group-hover:bg-[#4F46E5] group-hover:text-white transition-all">
                    ...
                    <p class="text-slate-500 font-medium leading-relaxed">
                        Gestion complète des filières, modules, salles et emplois du temps avec une visibilité totale
                        sur les effectifs.
                    </p>
                </div>
                ...
                <div
                    class="bg-white p-12 rounded-[3rem] border border-slate-100 shadow-[0_20px_50px_rgba(0,0,0,0.02)] hover:shadow-xl hover:-translate-y-2 transition-all group">
                    <div
                        class="w-16 h-16 rounded-2xl bg-emerald-50 text-emerald-600 flex items-center justify-center mb-8 group-hover:bg-emerald-600 group-hover:text-white transition-all">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div
                    class="bg-white p-12 rounded-[3rem] border border-slate-100 shadow-[0_20px_50px_rgba(0,0,0,0.02)] hover:shadow-xl hover:-translate-y-2 transition-all group">
                    <div
                        class="w-16 h-16 rounded-2xl bg-amber-50 text-amber-600 flex items-center justify-center mb-8 group-hover:bg-amber-600 group-hover:text-white transition-all">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <p class="text-slate-500 font-medium leading-relaxed">
                        Consultation en temps réel des résultats académiques, de la progression et de l'emploi du temps
                        du jour.
                    </p>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
            <div class="col-span-1 md:col-span-2">
                ...
                <div class="flex gap-4">
                    ...
                    <div
                        class="w-10 h-10 rounded-full bg-slate-800 hover:bg-[#4F46E5] transition-colors cursor-pointer flex items-center justify-center">
